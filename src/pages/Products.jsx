      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our complete collection of handcrafted candles, each one designed to create the perfect ambiance for any moment.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div
            ...
            className={`${showFilters ? 'block' : 'hidden'} md:block bg-white p-6 rounded-lg shadow-sm space-y-6`}
          >
            {/* Category Filters */}
            <div>
